...
| **NIM** | A11.2023.15413 |
| **Kelas** | A11.4602 |
| **Repository** | https://github.com/Yolaaapm/P-Sisi-Server.git |
...
|------|----------|----------|
| Admin | fiola | fiola456 |
| Instructor | instructor_fiola | fiola123 |
| Student | fiola | fiola456 |

> Catatan: Pada implementasi project ini, akun **fiola** memiliki role **student** sekaligus status **superuser** sehingga digunakan sebagai akun admin saat pengujian hak akses administrator.
